        ...
        try:
            ...
            if os.path.exists('webcfg.json') == True:
                ...
                with open('webcfg.json', "w") as f:
                    json.dump({"rproxy": "NONE", "ruseragent": "RANDOM", "rreferer": "RANDOM", "rhost": "NONE", "rxforw": "on", "rxclient": "on", "rtimeout": "10", "rretries": "1", "rdelay": "0"}, f, indent=4)
...
<pre>
 <div><a id="mH1" href="javascript:show('nb1');" style="text-decoration: none;" >+ Project info</a></div><div class="nb" id="nb1" style="display: none;">
  ...
  You have a technical schema about an attacking scenario: <a href="http://ufonet.sf.net/ufomet/ufonet-schema.png" target="_blank">here</a>
...
"""
    ...
    def get(self, request):
        ...
        cmd_options = "--proxy='" + self.rproxy + "' --user-agent='" + self.ruseragent + "' --referer='" + self.rreferer + "' --host='" + self.rhost + "' --timeout='" + self.rtimeout + "' --retries='" + self.rretries + "' --delay='" + self.rdelay + "'"
        if self.rxforw == "on":
        ...
        if page == "/requests":
            ...
            with open('webcfg.json', "w") as f:
                json.dump({"rproxy": frm_rproxy, "ruseragent": frm_ruseragent, "rreferer": frm_rreferer, "rhost": frm_rhost, "rxforw": frm_rxforw, "rxclient": frm_rxclient, "rtimeout": frm_rtimeout, "rretries": frm_rretries, "rdelay": frm_rdelay}, f, indent=4)
            self.pages["/requests"] = self.html_requests()
